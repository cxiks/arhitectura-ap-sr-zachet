Вот готовый шаблон в формате Markdown (`.md`), оптимизированный для оформления отчёта по лабораторной работе. В нём сохранены все ваши команды, добавлены логические разделы, блоки кода и чёткие плейсхолдеры для скриншотов.

Просто скопируйте содержимое в файл с расширением `.md` (например, `lab_ssh.md`) и замените пути к изображениям на реальные.
