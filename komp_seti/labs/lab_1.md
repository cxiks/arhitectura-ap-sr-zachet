...
![Рисунок 1.2 - Топология звезды и непосредственное соединение](путь_к_изображению_рис1.2.png)
*Рис. 1.2 - Сеть 10BaseT/100BaseTX: а) звезда, б) непосредственное соединение двух компьютеров*

### Схемы обжима кабеля

![Рисунок 1.3 - Прямой и перекрестный кабели](путь_к_изображению_рис1.3.png)
*Рис. 1.3 - Интерфейсные кабели Ethernet: а) прямой, б) перекрестный (кроссовый)*

![Рисунок 1.4 - Гальваническая развязка](путь_к_изображению_рис1.4.png)
...
![Рисунок 1.5 - Обжимной инструмент](путь_к_изображению_рис1.5.png)
...
![Рисунок 1.6 - Варианты заделки проводов (568A и 568B)](путь_к_изображению_рис1.6.png)
*Рис. 1.6 - Варианты заделки проводов (схемы T568A и T568B)*

![Рисунок 1.7 - Порядок обжима вилки](путь_к_изображению_рис1.7.png)
*Рис. 1.7 - Порядок обжима вилки RJ-45*

![Рисунок 1.8 - 4-жильный кабель](путь_к_изображению_рис1.8.png)
...
![Рисунок 1.9 - Сетевая карта PCI](путь_к_изображению_рис1.9.png)
